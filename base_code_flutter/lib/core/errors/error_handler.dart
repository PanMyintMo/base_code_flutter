...
ErrorHandler mapToErrorHandler(dynamic e) {
  if (e is DioException) {
    return ErrorHandler.dioException(error: e);
  } else if (e is ErrorHandler) {
    return e;
  } else {
    return ErrorHandler.otherException(e.toString());
  }
}
...
class ErrorHandler implements Exception {
  ...
  String handleBadRequest(Map<String, dynamic>? errorData) {
    ...
    } else if (errorData?['data']['msg'] != null) {
      final message = errorData?['data']['msg'];
      error = message;
    } else {
